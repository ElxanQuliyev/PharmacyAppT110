...
{
    public partial class PharmacyDBT110Context : DbContext
    {
        public PharmacyDBT110Context()
        {
        }

        public PharmacyDBT110Context(DbContextOptions<PharmacyDBT110Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data source=.\\;initial catalog=PharmacyDBT110;integrated security=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TagToMedicine>(entity =>
            {
                entity.HasKey(e => e.TagMedicineId)
                    .HasName("PK__TagToMed__7D1138134EB6F412");
